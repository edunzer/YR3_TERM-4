...
namespace FutureValue
{
    public partial class Form1 : Form
    {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            try
            {
                if (IsValidData())
                {
                    ...
                    recArray[r, 0] = monthlyInvestment.ToString("c");
                    recArray[r, 1] = (interestRateYearly / 100).ToString("P1");
                    recArray[r, 2] = years.ToString("N0");
                    recArray[r, 3] = futureValue.ToString("c");
                    r++;
                }
            }
            catch (Exception ex)
        ...
        private void btnExit_Click(object sender, EventArgs e)
        {
            ...
            while (i < recArray.GetLength(0))
            {
                if (recArray[1, 0] != null)
                {
                    message += "\r";
                    while(j < recArray.GetLength(1))
                    {
